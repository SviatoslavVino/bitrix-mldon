...
<head>
    ...
    <link rel="icon"
          type="image/png"
          sizes="160x160"
          href="<?=SITE_TEMPLATE_PATH?>/images/icons/favicons/160-160.png"
    >
    <link rel="icon"
          type="image/png"
          sizes="32x32"
          href="<?=SITE_TEMPLATE_PATH?>/images/icons/favicons/32-32.png"
    >
    <link rel="icon"
          type="image/png"
          sizes="16x16"
          href="<?=SITE_TEMPLATE_PATH?>/images/icons/favicons/16-16.png"
    >
    <link rel="icon"
          type="image/svg+xml"
          sizes="any"
          href="<?=SITE_TEMPLATE_PATH?>/images/icons/favicon.svg"
    >
    <link rel="apple-touch-icon"
          href="<?=SITE_TEMPLATE_PATH?>/images/icons/favicons/160-160.png"
    >

    <?if($APPLICATION->GetCurDir() === '/about-us/'):?>
